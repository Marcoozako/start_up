...
class EvenementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evenement" do
    assert_difference("Evenement.count") do
      post evenements_url, params: { evenement: { content: @evenement.content, date: @evenement.date, participant: @evenement.participant, title: @evenement.title } }
    end
  ...
  test "should update evenement" do
    patch evenement_url(@evenement), params: { evenement: { content: @evenement.content, date: @evenement.date, participant: @evenement.participant, title: @evenement.title } }
